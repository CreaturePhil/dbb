...
Methods.prototype.findAll = Methods.prototype.getAll;

Methods.prototype.getAllSync = function() {
  var json = JSON.parse(fs.readFileSync(this.file, 'utf8'));
  return json[this.collection];
};
Methods.prototype.findAllSync = Methods.prototype.getAllSync;

Methods.prototype.find = function(document, callback) {
  var _this = this;
  fs.readFile(this.file, 'utf8', function(err, data) {
    var json = JSON.parse(data);
    var doc = find(json[_this.collection], document);
